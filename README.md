...
Every picture devtree draws — the tree above, the board, the interactive page — comes out of one
vocabulary of twenty components.
...
The gallery is generated by walking the component list, so a component added without a demo fails
the build rather than quietly going undocumented. More: [docs/components.md](docs/components.md).
